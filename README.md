...
To run your tests locally, go to the root directory of the sample code and run the `npm install` command to install the 
required dependencies. Then run the `npm test` command, which AWS CodeBuild also runs through your `buildspec.yml` 
file.
